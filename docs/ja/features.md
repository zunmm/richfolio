...
メールと Telegram に加えて、Richfolio は買いシグナルを公開ソーシャルページ — **X/Twitter**、**Facebook ページ**、**LinkedIn ページ** — に**オプションで**投稿できます（毎日モードとザラ場モードのみ。週次や refresh では決して投稿しません）。投稿はあえて汎用的にしてあります：**STRONG BUY** と **BUY** のシグナルのみで、それぞれティッカー、アクション、信頼度、短い理由を表示します。

プライベートな情報は一切開示されません — 配分、ギャップ、保有、推奨買い金額は**決して**投稿されず、ポートフォリオと watch list のティッカーは「シグナル」として一様にまとめられるため、保有しているかどうかは決して明かされません。すべての投稿は *「投資助言ではありません」* という免責事項で終わります。
