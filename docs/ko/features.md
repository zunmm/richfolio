...
이메일과 Telegram 외에도, Richfolio는 일일 및 장중 모드에서(주간이나 refresh 모드에서는 절대 아님) 매수 신호를 공개 소셜 페이지 — **X/Twitter**, **Facebook 페이지**, **LinkedIn 페이지** — 에 **선택적으로** 게시할 수 있습니다. 게시물은 의도적으로 일반적입니다: **STRONG BUY**와 **BUY** 신호만 다루며, 각각 종목, 액션, 신뢰도, 그리고 짧은 이유를 보여줍니다.

비공개 정보는 전혀 공개되지 않습니다 — 배분, 격차, 보유 종목, 추천 매수 금액은 **절대** 게시되지 않으며, 포트폴리오와 워치 리스트 티커는 "신호"로 동일하게 합쳐져 보유 여부가 드러나지 않습니다. 모든 게시물은 *"투자 자문이 아님(Not financial advice)"* 면책 문구로 끝납니다.
